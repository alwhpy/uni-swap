import { migration0 } from 'views/swap/Widget2/state/migrations/0'
import { migration1 } from 'views/swap/Widget2/state/migrations/1'
import { migration2 } from 'views/swap/Widget2/state/migrations/2'
import { migration3 } from 'views/swap/Widget2/state/migrations/3'
import { migration4 } from 'views/swap/Widget2/state/migrations/4'
import { migration5 } from 'views/swap/Widget2/state/migrations/5'
import { migration6 } from 'views/swap/Widget2/state/migrations/6'
import { migration7 } from 'views/swap/Widget2/state/migrations/7'
import { legacyLocalStorageMigration } from 'views/swap/Widget2/state/migrations/legacy'
