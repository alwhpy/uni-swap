...
export const schema11 = {
  ...
  definitions: {
    ...
    TagDefinition: {
      ...
      additionalProperties: false,
      properties: {
        name: { type: 'string', description: 'The name of the tag', pattern: '^[ \\w]+$', minLength: 1, maxLength: 20 },
        description: {
          type: 'string',
      ...
      examples: [{ name: 'Stablecoin', description: 'A token with value pegged to another asset' }]
    },
    TokenInfo: {
      type: 'object',
...
const func2 = import('ajv/dist/runtime/ucs2length').default
const pattern0 = new RegExp('^[\\w ]+$', 'u')
const pattern4 = new RegExp('^[\\w]+$', 'u')
const pattern10 = new RegExp('^[ \\w]+$', 'u')
const pattern11 = new RegExp('^[ \\w\\.,:]+$', 'u')
const formats0 = import('ajv-formats/dist/formats').fullFormats['date-time']
const formats2 = import('ajv-formats/dist/formats').fullFormats.uri
...
export const schema23 = { anyOf: [{ $ref: '#/definitions/ExtensionPrimitiveValue' }] }
...
function validate10(data, { instancePath = '', parentData, parentDataProperty, rootData = data } = {}) {
  /*# sourceURL="https://uniswap.org/tokenlist.schema.json" */ let vErrors = null
  parentDataProperty
  parentData
  let errors = 0
  if (errors === 0) {
                              ...
                              for (const key3 in data8) {
                                ...
                                if (
                                  !validate11(data8[key3], {
                                    instancePath:
                                      instancePath + '/tokenMap/' + key3.replace(/~/g, '~0').replace(/\//g, '~1'),
                                    parentData: data8,
                                ...
                                for (const key5 in data12) {
                                  ...
                                  if (errors === _errs36) {
                                    if (data13 && typeof data13 == 'object' && !Array.isArray(data13)) {
                                      let missing2
                                      if (
                                        (data13.name === undefined && (missing2 = 'name')) ||
                                        (data13.description === undefined && (missing2 = 'description'))
                                      ) {
                                        validate10.errors = [
                                          {
                                            instancePath:
                                              instancePath + '/tags/' + key5.replace(/~/g, '~0').replace(/\//g, '~1'),
