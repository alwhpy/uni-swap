...
const StyledInput = styled.input<{
  ...
  color: ${({ error, theme, $isWhiteBg }) => (error ? theme.critical : $isWhiteBg ? '#121212' : theme.neutral1)};
...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ value, onUserInput, placeholder, prependSymbol, maxDecimals, isWhiteBg, ...rest }: InputProps, ref) => {
