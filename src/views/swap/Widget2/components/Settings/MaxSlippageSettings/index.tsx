...
export default function MaxSlippageSettings({ autoSlippage }: { autoSlippage: Percent }) {
  ...
  return (
    <Expand
      ...
      header={
        <Row width="auto">
          <ThemedText.BodySecondary>Max. slippage</ThemedText.BodySecondary>
          <QuestionHelper
    ...
    >
      <RowBetween gap="md">
        <Switch>
          ...
          >
            <ThemedText.BodyPrimary>Auto</ThemedText.BodyPrimary>
          </Option>
          <Option
            onClick={() => {
            ...
            isActive={userSlippageTolerance !== SlippageTolerance.Auto}
          >
            <ThemedText.BodyPrimary>Custom</ThemedText.BodyPrimary>
          </Option>
        </Switch>
