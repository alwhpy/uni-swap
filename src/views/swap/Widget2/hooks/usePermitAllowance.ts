...
import PERMIT2_ABI from '../lib/uniswap/src/abis/permit2.json'
import { Permit2 } from '../lib/uniswap/src/abis/types/Permit2'
...
export function usePermitAllowance(token?: Token, owner?: string, spender?: string) {
  ...
  const result = useSingleCallResult(chainId, contract, 'allowance', inputs, {
    blocksPerFetch
