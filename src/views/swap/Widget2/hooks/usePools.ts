...
import IUniswapV3PoolStateJSON from '../lib/uniswap/src/abis/IUniswapV3PoolState.json'
...
import { IUniswapV3PoolStateInterface } from '../lib/uniswap/src/abis/types/v3/IUniswapV3PoolState'
import { UniswapV3Pool } from '../lib/uniswap/src/abis/types/v3/UniswapV3Pool'
import { useContractMultichain } from './useContractMultichain'
...
export function usePools(
  ...
  const slot0s = useMultipleContractSingleData(chainId, poolAddresses, POOL_STATE_INTERFACE, 'slot0')
  const liquidities = useMultipleContractSingleData(chainId, poolAddresses, POOL_STATE_INTERFACE, 'liquidity')
