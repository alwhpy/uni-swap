...
export function useSwapCallback(
  ...
  return useCallback(async () => {
    ...
    return result
  }, [account, addTransaction, chainId, swapCallback, trade])
}
