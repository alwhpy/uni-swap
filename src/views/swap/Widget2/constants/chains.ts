...
export const CHAIN_IDS_TO_NAMES: { [key in ChainId]?: string } = {
...
export type SupportedInterfaceChain = Partial<SupportedChainsType>
...
export const SUPPORTED_GAS_ESTIMATE_CHAIN_IDS = [ChainId.MAINNET, ChainId.BIT_DEVNET, ChainId.BIT_MAINNET] as const
...
export const TESTNET_CHAIN_IDS = [ChainId.GOERLI, ChainId.SEPOLIA] as const

/**
 * All the chain IDs that are running the Ethereum protocol.
 */
export const L1_CHAIN_IDS = [ChainId.MAINNET, ChainId.GOERLI, ChainId.SEPOLIA] as const
