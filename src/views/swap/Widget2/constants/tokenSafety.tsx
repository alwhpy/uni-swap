...
import { TokenStandard } from '../lib/uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks'
    ...
    switch (warning.level) {
      case WARNING_LEVEL.MEDIUM:
        heading = (
          ...
          } isn't traded on leading U.S. centralized exchanges.`}</Typography>
        )
        description = <Typography>Always conduct your own research before trading.</Typography>
        break
      case WARNING_LEVEL.UNKNOWN:
        heading = (
          ...
          <Typography>{`${
            tokenSymbol ?? 'This token'
          } isn't traded on leading U.S. centralized exchanges or frequently swapped on Uniswap.`}</Typography>
        )
        description = <Typography>Always conduct your own research before trading.</Typography>
        break
      case WARNING_LEVEL.BLOCKED:
        description = (
          ...
          // />
          <Typography>{`You can't trade ${tokenSymbol ?? 'this token'} using the Uniswap App.`}</Typography>
        )
        break
    }
  }
...
export const MediumWarning: Warning = {
  ...
  message: <Typography>Caution</Typography>,
  canProceed: true
}

export const StrongWarning: Warning = {
  level: WARNING_LEVEL.UNKNOWN,
  message: <Typography>Warning</Typography>,
  canProceed: true
}

export const BlockedWarning: Warning = {
  level: WARNING_LEVEL.BLOCKED,
  message: <Typography>Not available</Typography>,
  canProceed: false
}

export const NotFoundWarning: Warning = {
  level: WARNING_LEVEL.UNKNOWN,
  message: <Typography>Token not found</Typography>,
  canProceed: false
}
